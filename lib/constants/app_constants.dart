...
// Supabase project (rbdjjzqdhftrzlwrewej)
const String kSupabaseUrl = 'https://rbdjjzqdhftrzlwrewej.supabase.co';

/// anon public key จาก Project Settings → API
const String kSupabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJiZGpqenFkaGZ0cnpsd3Jld2VqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODY4NTkyMjYsImV4cCI6MjEwMjQzNTIyNn0.wBUj_YJf6SwptOC1X6alsh2egKhKhq99n9M4GfOw4ys';

/// AI Mentor = Supabase Edge Function
const String kMentorApiUrl = '$kSupabaseUrl/functions/v1/mentor';
